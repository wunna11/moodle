...
$string['submitrequestdesc'] = 'Nominate {$a} for a scholarship.';
...
$string['errorscholarshippending'] = 'A pending request already exists for this fee record and scholarship.';
