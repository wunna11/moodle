...
class scholarshiprequest_manager {
    ...
    /**
     * Whether a PENDING request already exists for this exact fee
     * record + scholarship pair - blocks duplicate nominations from
     * piling up in the approval queue.
     *
     * @param int $feerecordid
     * @param int $scholarshipid
     * @return bool
    ...
    public static function has_pending_request(int $feerecordid, int $scholarshipid): bool {
        ...
        return $DB->record_exists('financedep_scholarshipreq', [
            'feerecordid' => $feerecordid,
            'scholarshipid' => $scholarshipid,
