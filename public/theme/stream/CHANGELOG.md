...
- Standard login page
- Fix drawers
- Print course shortname instead of full name in the course index heading
- Remove default copy information from the login page

## Version 1.7 - 2026-05-16
- [FIX] Main slider - Bootstrap 5 compatible
- [FIX] Secondary navigation alignment
- [FIX] Navigation hook active only if Stream is in use
