...
$string['removelogincopy'] = 'Remove login copy';
$string['removelogincopy_desc'] = 'Keep only the image on the left and remove the default text content.';
...
// End of Privacy API.
$string['courseindexheading'] = 'Show fullname or shortname';
