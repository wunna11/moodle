...
// FIX: get_context_instance(CONTEXT_SYSTEM) အစား Modern Moodle Context API သို့ ပြောင်းထားပါသည်
...
// FIX: set_url လမ်းကြောင်းအမှန် ပြောင်းထားပါသည်
$PAGE->set_url('/blocks/enrolltranscripts/transcript.php', $params);
