...
/**
 * Approve/reject a discount request.
 *
...
/**
 * Class discountrequestreview_form
 *
 * Identical shape to scholarshiprequestreview_form - see that class's
 * docblock. customdata keys: requestid (int), decision
 * ('approve'|'reject'), suggestedamount (float).
 */
class discountrequestreview_form extends \moodleform {
