...
<ul>
    ...
    <li>As restantes colunas devem ser estruturadas da seguinte forma:
        <ul>
            <li>O nome da coluna será usado como nome da série. Pode usar strings de tradução conforme explicado na
...
<blockquote>No exemplo abaixo, a primeira coluna devolve o nome da disciplina, e a segunda coluna devolve o número de notícias de cada disciplina:
<pre>SELECT fullname,
       newsitems AS "Quantidade de notícias da disciplina"
  FROM mdl_course</pre></blockquote>
<blockquote>No exemplo abaixo, além de a primeira coluna ser o nome da disciplina, são geradas duas linhas adicionais no gráfico, com nomes de colunas traduzidos:
