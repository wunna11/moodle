...
$string['pluginname_desc'] = 'Exibe uma tabela com paginação de dados.';
...
$string['table_first_records'] = 'Os dez primeiros registros da consulta';
$string['table_info_topo'] = 'Primeiro, você verá uma prévia dos resultados da consulta. Em seguida, será apresentada uma série de colunas para você nomear os títulos e definir o formato dos dados de cada coluna.';
$string['table_info_types'] = 'Você agora pode definir um nome para a coluna e depois especificar o formato desejado, além de informar se deseja alguma formatação extra com Mustache.
<ul>
    <li><strong>Sem formatação</strong>: Exibe o conteúdo exatamente como ele está ou aplica Mustache caso você adicione.</li>
    ...
    <ul><li>Mustache não disponível</li></ul>
    <li><strong>Converter coluna para nome completo "fullname()"</strong>: Executa a função <code>fullname()</code> para gerar o nome completo com base no idioma, que será armazenado nesta mesma coluna. Para isso funcionar, a coluna <code>lastname</code> é obrigatória e deve ser ocultada, se possível.</li>
    ...
    <li><strong>Campo binário para Ativo/Inativo</strong>: Usa o valor binário para determinar o status, em que "0"/"false" significa Inativo e "1"/"true" significa Ativo.</li>
    <li><strong>Campo "Time" formatado como data</strong>: Converte o valor de tempo (timestamp) da coluna para uma data legível, exibindo apenas a data (dia/mês/ano).</li>
    <ul><li>Mustache não disponível</li></ul>
    <li><strong>Campo "Time" formatado como data e hora</strong>: Exibe o valor de tempo (timestamp) da coluna como uma data completa, incluindo a hora (dia/mês/ano e horas:minutos).</li>
    <ul><li>Mustache não disponível</li></ul>
    <li><strong>Campo "Time" formatado como hora</strong>: Formata o valor de tempo (timestamp) da coluna para exibir apenas a hora (horas:minutos), omitindo a data.</li>
    <ul><li>Mustache não disponível</li></ul>
</ul>';
