...
class request_form extends moodleform {
    ...
    public function definition(): void {
        ...
        // Editor အစား textarea ကို ပြောင်းလဲသုံးခြင်းဖြင့် require is not defined error ကို ဖြေရှင်းခြင်း
        $mform->addElement("textarea", "message_editor", get_string("request_message", "koperedashboard_requests"), 'wrap="virtual" rows="5" cols="70"');
